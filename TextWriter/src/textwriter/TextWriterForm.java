...
public class TextWriterForm extends javax.swing.JFrame {
    ...
    public TextWriterForm() {
        ...
        // We need to add a new thread here. The thread has 1 job, and that is 
        // to take backup every 15 min
    ...
    public class BackUp implements Runnable {
        ...
        private TextWriterForm textWriterForm;
        private String userDir;

        BackUp(TextWriterForm textWriterForm) {
            this.textWriterForm = textWriterForm;
            this.userDir = System.getProperty("user.home").toString() + "/Downloads";
        }
